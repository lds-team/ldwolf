...
public class ContactDBHelper extends BaseDBHelper {
    ...
    public static HashMap<String, ContactModel> getFullContact() {
        return db.getFullContact();
    }
    ...
    public static String getNameKhachChuyen(String phone) {
        return db.getNameKhachChuyen(phone);
    }
}

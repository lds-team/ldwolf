...
public class ConfigFragment extends Basev4Fragment implements CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    @Bind(R.id.config_acceptdup)
    CheckBox settingReceiveDup;
    ...
    private boolean isReceiveDupplicate;
    ...
    private void loadingConfig(View view) {
        //------
        settingReceiveDup.setChecked(SettingsHelper.getReceiveDupplicate(getSaved()));
    ...
    R.id.config_long_message, R.id.config_message_160, R.id.config_message_320, R.id.config_message_480, R.id.config_acceptdup})
    @Override
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.config_acceptdup:
                isReceiveDupplicate = settingReceiveDup.isChecked();
                break;
    ...
    public void saveSwitchConfig() {
        ...
        SettingsHelper.saveReceiveDupplicate(getSaved(), isReceiveDupplicate);
